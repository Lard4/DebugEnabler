...
//        // Setup
//        this.finskyDebugToggle = (ToggleButton) mainActivity.findViewById(R.id.FinskyDebugToggle);
//        this.finskyDebug2Toggle = (ToggleButton) mainActivity.findViewById(R.id.FinskyDebug2Toggle);
//        this.babelDebugToggle = (ToggleButton) mainActivity.findViewById(R.id.BabelDebugToggle);
//        this.babelGVToggle = (ToggleButton) mainActivity.findViewById(R.id.BabelGVToggle);
//        this.musicDebugToggle = (ToggleButton) mainActivity.findViewById(R.id.MusicDebugToggle);
//        this.gamesDogfoodToggle = (ToggleButton) mainActivity.findViewById(R.id.GamesDogfoodToggle);
//        this.moviesDogfoodToggle = (ToggleButton) mainActivity.findViewById(R.id.MoviesDogfoodToggle);
//        this.booksDebugToggle = (ToggleButton) mainActivity.findViewById(R.id.BooksDebugToggle);
//        this.newsstandButton = (Button) mainActivity.findViewById(R.id.newsstandButton);
